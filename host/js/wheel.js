...
(() => {
  ...
  function bindCanvas(){
    canvas = document.getElementById("wheelCanvas") || document.getElementById("wheel");
  ...
  function spinWheel(direction, options = {}, onDone){
    if (typeof options === "function"){ onDone = options; options = {}; }
    ...
    const landingAdjust = ((finalRotation - startRotation) % (Math.PI*2) + Math.PI*2) % (Math.PI*2);
